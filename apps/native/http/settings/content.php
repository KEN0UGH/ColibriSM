...
if (empty($cl["is_logged"])) {
	...
	$cl["muted_words"]   = cl_get_muted_words($cl['me']['id']);
	$cl["settings_app"]  = fetch_or_get($_GET["sapp"], false);
	$cl["settings_app"]  = (not_empty($cl["settings_app"])) ? cl_text_secure($cl["settings_app"]) : 0;
	$cl["settings_apps"] = array("name", "email", "phone", "siteurl", "bio", "gender", "password", "language", "country", "city", "verification", "privacy", "notifications", "blocked", "muted", "muted_words", "delete", "information", "email_notifs", "cont_monetization", "social_links", "alt_accounts");
