...
$media_placeholders = array(
    ...
    'upload/default/faces/avatar-1.png',
    'upload/default/faces/avatar-2.png',
    'upload/default/faces/avatar-3.png',
    'upload/default/faces/avatar-4.png',
    'upload/default/faces/avatar-5.png',
    'upload/default/faces/avatar-6.png',
    'upload/default/faces/avatar-7.png',
    'upload/default/faces/avatar-8.png',
    'upload/default/faces/avatar-9.png',
    'upload/default/faces/avatar-10.png',
    'upload/default/faces/avatar-11.png',
    'upload/default/faces/avatar-12.png',
    'upload/default/faces/avatar-13.png',
    'upload/default/faces/avatar-14.png',
    'upload/default/faces/avatar-15.png',
    'upload/default/faces/avatar-16.png',
    'upload/default/faces/avatar-17.png',
    'upload/default/faces/avatar-18.png',
    'upload/default/faces/avatar-19.png',
    'upload/default/faces/avatar-20.png',
    'upload/default/faces/avatar-21.png',
    'upload/default/faces/avatar-22.png',
    'upload/default/faces/avatar-23.png',
    'upload/default/faces/avatar-24.png',
    'upload/default/faces/avatar-25.png',
    'upload/default/faces/avatar-26.png',
    'upload/default/faces/avatar-27.png',
    'upload/default/faces/avatar-28.png',
    'upload/default/faces/avatar-29.png',
    'upload/default/faces/avatar-30.png',
    'upload/default/faces/avatar-31.png',
    'upload/default/faces/avatar-32.png',
    'upload/default/faces/avatar-33.png',
    'upload/default/faces/avatar-34.png',
    'upload/default/faces/avatar-35.png',
    'upload/default/faces/avatar-36.png',
    'upload/default/faces/avatar-37.png',
    'upload/default/faces/avatar-38.png',
    'upload/default/faces/avatar-39.png',
    'upload/default/faces/avatar-40.png',
    'upload/default/faces/avatar-41.png',
    'upload/default/faces/avatar-42.png',
    'upload/default/faces/avatar-43.png',
    'upload/default/faces/avatar-44.png',
    'upload/default/faces/avatar-45.png',
    'upload/default/faces/avatar-46.png',
    'upload/default/faces/avatar-47.png',
    'upload/default/faces/avatar-48.png',
    'upload/default/faces/avatar-49.png',
    'upload/default/faces/avatar-50.png',
    'upload/default/faces/avatar-51.png',
    'upload/default/faces/avatar-52.png',
    'upload/default/faces/avatar-53.png',
    'upload/default/faces/avatar-54.png',
    'upload/default/faces/avatar-55.png'
);

$cl["media_placeholders"] = $media_placeholders;
...
$cl['morer_perms'] = array(
    "aboutus" => array(
        "page_name" => "About us page",
        "desc" => "Permission to edit the about us page"
    ),
    "account_reports" => array(
        "page_name" => "Account reports",
        "desc" => "Permission to manage requests of account reports"
    ),
    "account_verification" => array(
        "page_name" => "Account verification",
        "desc" => "Permission to manage account verification requests"
    ),
    "ads_settings" => array(
        "page_name" => "Advertising settings",
        "desc" => "Permission to edit site ads settings page"
    ),
    "affiliate_payouts" => array(
        "page_name" => "Affiliate payouts",
        "desc" => "Permission to manage affiliate payout requests"
    ),
    "affiliate_settings" => array(
        "page_name" => "Affiliate settings",
        "desc" => "Permission to edit affiliate settings page"
    ),
    "app_links" => array(
        "page_name" => "Mobile app links (IOS/Android/Mi)",
        "desc" => "Permission to edit mobile app download links page"
    ),
    "auto_follow" => array(
        "page_name" => "Auto follow settings",
        "desc" => "Permission to edit new users auto follow settings page"
    ),
    "aws3" => array(
        "page_name" => "Amazon S3 settings",
        "desc" => "Permission to edit amazon-s3 cloud storage settings page"
    ),
    "backups" => array(
        "page_name" => "Site backups",
        "desc" => "Permission to manage site backups page"
    ),
    "banktrans_receipts" => array(
    ...
    "custom_jscss" => array(
        "page_name" => "Custom CSS/JavaScript",
        "desc" => "Permission to edit custom CSS/JavaScript settings page"
    ),
    "delete_spam_accounts" => array(
        "page_name" => "Delete spam accounts",
        "desc" => "Permission to delete spam accounts"
    ),
    "delete_swifts" => array(
        "page_name" => "Delete expired swifts",
        "desc" => "Permission to delete expired (Stories) swifts of users"
    ),
    "display_settings" => array(
        "page_name" => "Display settings",
        "desc" => "Permission to edit user interface display settings page"
    ),
    "email_settings" => array(
        "page_name" => "Email (SMTP) settings",
        "desc" => "Permission to edit SMTP settings page"
    ),
    "faqs" => array(
        "page_name" => "F.A.Qs page",
        "desc" => "Permission to edit the FAQs info page"
    ),
    "gen_settings" => array(
        "page_name" => "General (Main) settings",
        "desc" => "Permission to edit site general settings page"
    ),
    "google_ads" => array(
        "page_name" => "Google ads settings",
        "desc" => "Permission to edit Google ads settings page"
    ),
    "idrive_s3" => array(
        "page_name" => "iDrive S3 settings",
        "desc" => "Permission to edit iDrive-s3 cloud storage settings page"
    ),
    "infobip_settings" => array(
        "page_name" => "InfoBip SMS provider",
        "desc" => "Permission to edit InfoBip settings page"
    ),
    "invite_users" => array(
        "page_name" => "InfoBip SMS provider",
        "desc" => "Permission to edit InfoBip settings page"
    ...
    "languages" => array(
        "page_name" => "Site languages",
        "desc" => "Permission to edit site languages settings page"
    ),
    "manage_ads" => array(
        "page_name" => "User Ads",
        "desc" => "Permission to manage user advertisings page"
    ),
    "media_filter" => array(
        "page_name" => "Google Vison (Media filter)",
        "desc" => "Permission to edit media filter settings page"
    ),
    ...
    "oauth_settings" => array(
        ...
        "desc" => "Permission to edit social login settings page"
    ),
    "payment_gateways" => array(
        "page_name" => "Payment gateways",
        "desc" => "Permission to manage payment gateway provider settings page"
    ),
    "post_censor_settings" => array(
        "page_name" => "Post censor",
        "desc" => "Permission to edit post censored words settings page"
    ),
    "post_reports" => array(
        "page_name" => "Post reports",
        "desc" => "Permission to manage post reports page"
    ),
    "premium_account" => array(
        "page_name" => "Premium account settings",
        "desc" => "Permission to edit user premium account settings page"
    ),
    "privacy_policy" => array(
        "page_name" => "Privacy policy",
        "desc" => "Permission to edit the privacy policy terms page"
    ),
    "publications" => array(
        "page_name" => "User publications",
        "desc" => "Permission to manage user publications/posts info"
    ),
    "push_notifications" => array(
        "page_name" => "Push notif settings",
        "desc" => "Permission to edit push notifications settings page"
    ),
    "recaptcha" => array(
        "page_name" => "reCAPTCHA (Google)",
        "desc" => "Permission to edit google reCAPTCHA settings page"
    ),
    "restrictions" => array(
        "page_name" => "User data restrictions",
        "desc" => "Permission to edit user info restrictions settings page"
    ),
    "sitemap" => array(
        "page_name" => "Sitemap (XML)",
        "desc" => "Permission to edit site map settings page"
    ),
    "terms_of_use" => array(
        "page_name" => "Terms of use",
        "desc" => "Permission to edit the terms of use page"
    ),
    "themes" => array(
        "page_name" => "UI themes",
        "desc" => "Permission to manage site UI themes page"
    ),
    "timezone" => array(
        "page_name" => "Timezone settings",
        "desc" => "Permission to edit timezone settings page"
    ),
    "toggle_features" => array(
        "page_name" => "Toggle features",
        "desc" => "Permission to toggle (Enable/Disable) site features"
    ),
    "twilio_settings" => array(
        "page_name" => "Twilio settings (SMS) provider",
        "desc" => "Permission to edit Twilio SMS provider settings"
    ),
    "users" => array(
        "page_name" => "Site users",
        "desc" => "Permission to site users page"
    ),
    "wallet_balance"  => array(
        "page_name" => "Edit user wallet",
        "desc" => "Permission to edit user wallet balance"
    ),
    "wasabi_s3" => array(
        "page_name" => "Wasabi s3 storage",
        "desc" => "Permission to edit Wasabi S3 storage settings page"
    ),
    "withdrawal_requests" => array(
        "page_name" => "Withdrawal requests",
        "desc" => "Permission to edit user withdrawal requests page"
    )
);
